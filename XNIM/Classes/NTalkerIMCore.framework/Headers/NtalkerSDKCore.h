...
///会话状态
- (void)ntalkerConversationStatus:(NTALKER_STATUS )status siteId:(NSString *)siteId;
///客服离开
...
///获取到历史消息
- (void)ntalkerDidFetchHistoryMessages:(NSMutableArray <NtalkerCoreMessage *>*)mesages siteId:(NSString *)siteId;
///访客被加入黑名单
...
/**
 ...
 @param siteId 站点
 */
- (void)ntalker_pageView:(NSString *)pageName web:(NSDictionary *)web order:(NSDictionary *)order product:(NSDictionary *)product event:(NSDictionary *)event custom:(NSDictionary *)customDict siteId:(NSString *)siteId;
/**
 上传轨迹信息(参数是数据模型)
 ...
 @param siteId 站点
 */
- (void)ntalker_withPageView:(NSString *)pageName web:(NtalkerWebModel *)web order:(NtalkerOrderModel *)order product:(NtalkerProductModel *)product event:(NtalkerEventModel *)event custom:(NSDictionary *)customDict siteId:(NSString *)siteId;
#pragma mark - 评价配置
/**
 获取评价配置
 ...
 @param failure 失败
 */
- (void)ntalker_getEvaluateSettingsWithSiteId:(NSString *)siteId success:(successBlock)success failure:(failureBlock)failure;
#pragma mark - 商品信息
/**
 获取商品信息
 ...
 @param failure 失败回调
 */
- (void)ntalker_getGoodsDetailInfoWithProductId:(NSString *)productId siteId:(NSString *)siteId success:(successBlock)success failure:(failureBlock)failure;
#pragma mark - 用户切换
/**
 *  登录
 *
